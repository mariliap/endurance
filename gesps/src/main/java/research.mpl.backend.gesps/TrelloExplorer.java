...
public class TrelloExplorer {
    ...
    public static void main(String[] args) {
        ...
        String myApiKey = "2d569324b6afc1cbbf2402b847b5ab6d";
        String myToken = "bd06e9bb3b026ea315df528ffc7bd7e10cd552507de794b230cb4be79287d509" ;

//        https://trello.com/1/authorize?expiration=1day&scope=read,write,account&response_type=token&name=Server%20Token&key=2d569324b6afc1cbbf2402b847b5ab6d
        ...
        try {
            ...
            List<org.trello4j.model.List> trelloLists = trello.getListByBoard(boardSiconv);
            ...
            List<Card> cardsBackLog = trello.getCardsByList(listaCardsBackLog);
            ...
            trello.createCard(listaCardsBackLog, "TESTE", null);
